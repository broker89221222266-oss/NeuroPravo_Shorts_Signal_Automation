...
Локальный import-first инструмент для поиска и разбора источников под сценарии НейроПраво. После корректировки Александра главный сценарный источник ближайшего цикла: новости Business FM, а не юридические Shorts.

Инструмент ничего не публикует, не рендерит, не загружает в аккаунты и не подключает внешние API. На текущем этапе он берет готовый CSV из ручного импорта, Telegram-поста Business FM, сайта BFM.ru, Apify, ViewStats или другой выгрузки, валидирует строки, считает score и делает карточки сценариев.

## Главный сценарный поток: Business FM news-first
...
Подробная инструкция: `docs\BusinessFM_News_To_Reels_Workflow.md`.

YouTube Shorts остаются вспомогательным источником форматов подачи, но не главным источником тем для ближайшей работы.
